      ...
      <div className="w-full max-w-md p-8 border-4 border-foreground text-center">
        ...
        <div className="space-y-4 mb-6">
          <p className="text-sm leading-relaxed">
            We&apos;ve sent a confirmation email to your address. Just visit for 10 sec and close the link on the Supabase Auth mail in the email app to verify your account and get started with Cloudynic AI.
          </p>
        </div>
